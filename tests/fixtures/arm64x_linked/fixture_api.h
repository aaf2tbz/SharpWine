...
ARM64X_FIXTURE_API uint64_t fixture_arm_callback(uint64_t value);
ARM64X_FIXTURE_API uint64_t fixture_arm_nested_callback(uint64_t value);
ARM64X_FIXTURE_API uint64_t fixture_direct_x64_call(uint64_t value);
ARM64X_FIXTURE_API uint64_t fixture_callback_and_resume(uint64_t value);
ARM64X_FIXTURE_API uint64_t fixture_tail_transfer(uint64_t value);
ARM64X_FIXTURE_API uint64_t fixture_bounded_nested(uint64_t value);
